...
export const makeChatsSocket = (config) => {
    ...
    const upsertMessage = ev.createBufferedFunction(async (msg, type) => {
        ...
        if (!!msg.pushName) {
            let jid = msg.key.fromMe ? authState.creds.me.id : msg.key.participantAlt || msg.key.remoteJidAlt;
            let lid = msg.key.fromMe ? authState.creds.me.lid : msg.key.participant || msg.key.remoteJid;
            jid = jidNormalizedUser(jid);
            lid = jidNormalizedUser(lid);
            if (!msg.key.fromMe) {
                ev.emit('contacts.update', [{ id: jid, lid,notify: msg.pushName, verifiedName: msg.verifiedBizName }]);
            }
