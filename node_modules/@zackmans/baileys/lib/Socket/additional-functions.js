...
export default class zckmns {
    constructor(Utils_1, waUploadToServerFe, relayMessageFn, authStateFw) {
        this.utils = Utils_1;
        this.relayMessage = relayMessageFn
        this.waUploadToServer = waUploadToServerFe;
        this.authState = authStateFw;
        this.bail = {
    ...
    detectType(content) {
        if (content?.requestPaymentMessage) {
            ...
            return 'INTERACTIVE'
        } else if (content?.albumMessage) {
            return 'ALBUM'
        } else if (content?.eventMessage) {
            return 'EVENT'
        } else if (content?.pollResultMessage) {
            return 'POLL_RESULT'
        } else if (content?.groupStatus) {
            return 'GROUP_STORY'
        } else {
            return null
        }
    ...
    async handleAlbum(content, jid, quoted) {
        ...
        const album = await this.utils.generateWAMessageFromContent(jid, {
            ...
            userJid: this.authState.creds.me.id,
            quoted,
            upload: this.waUploadToServer
        });
            ...
            await this.relayMessage(jid, img.message, {
                ...
                quoted: {
                    key: {
                        ...
                        id: album.key.id,
                        fromMe: true,
                        participant: this.authState.creds.me.id,
                    },
    ...
    async handleGroupStory(content, jid, quoted) {
        ...
        const { backgroundColor } = storyData;
        delete storyData.backgroundColor;
        let waMsgContent;
